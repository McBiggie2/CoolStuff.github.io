...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		order=11000;
		new Game.Achievement('WATCH OUT A BOMB','You almost caused a national tragedy.<q>You should feel ashamed.</q>',[1,7]);Game.last.clickFunction=function(){if (!Game.HasAchiev('WATCH OUT A BOMB')){PlaySound('snd/tick.mp3');Game.Win('WATCH OUT A BOMB');}};
